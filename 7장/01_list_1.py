...
# 포도 추가 > + 연산자 이용 : 연결 연산자
fruits = fruits + ['포도'] # 포도를 더해서 fruits에 저장. num = num + 1과 비슷하다
...
print("과일 목록 : ", fruits)
print("과일 리스트 중 2,3,4,번 과일은?", fruits[1:4]) # 1번지부터 4번지 앞까지 슬라이싱
print("과일 리스트 중 1~3번 과일은? : ", fruits[0:3]) # 0번지부터 2번지까지
print("과일 리스트 중 1~3번 과일은? : ", fruits[:3]) # 처음부터 2번지까지
print("과일 리스트에서 3번 과일부터 마지막까지 과일은 ? : ", fruits[2:]) # 2번지부터 마지막까지
